...
export default abstract class AssaultRifle extends Weapon {

    constructor(name: string, weaponClass: string, img: string, description: string) {
        super(name, weaponClass, img, description);
